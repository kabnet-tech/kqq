...
[Report a vulnerability](https://github.com/kck8/kq/security/advisories/new)

Include:

- A description of the issue and its impact
- Steps to reproduce (a sample input file and the `kq` invocation are ideal)
- The version you tested against (`kq --version`)
...
kq is a command-line data processing tool. In-scope concerns include:
...
- kq is written in memory-safe-by-default Zig with explicit allocator
